...
def get_team_info():
    results = select_sql(sql_file_path="projects/teams_distance/resources", sql_file_name="teams_select.sql")
...
def load_nba_team_distances():
    while True:
        row = yield
        load_sql = read_sql_file(file_path='projects/teams_distance/resources/teams_distance_st.sql',
                                 team_id = row["team_id"],
